      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-3">
          <div className="relative p-8 rounded-xl shadow-lg bg-white border border-gray-100">
            <div className="absolute -top-8 left-6 w-16 h-16 bg-[#00003E] text-white text-2xl font-bold rounded-full flex items-center justify-center shadow-md">
              1
            </div>
            <h2 className="mt-10 text-2xl font-semibold text-[#00003E]">
