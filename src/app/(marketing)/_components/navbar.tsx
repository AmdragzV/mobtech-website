  ...
  return (
    <header className="bg-white">
      <nav className="bg-white">
        <div className="flex sm:flex sm:items-center justify-between px-4 md:px-[3.75rem] py-4 m-auto w-full max-w-[1340px]">
          <Image
          ...
          <Image
            ...
            width={70}
            height={50}
            className="block md:hidden w-12 h-8 rounded-full"
          />
          ...
          <Link href={"/login"}>
            <button className="hidden md:block px-6 py-2 bg-[#00008B] rounded-md text-lg font-semibold text-white hover:opacity-80">
              Login
            </button>
          </Link>
          <button
